          ...
          <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <form @submit.prevent="" class="space-y-4 md:space-y-6" action="#">
                      ...
                      <div>
                        <label for="" class="text-red-600">{{ errorMesg }}</label>
                        <label for="" class="text-green-600">{{ successMsg }}</label>
                      </div>
                      <div class="flex grid-cols-2 justify-between">
                        <button @click="gitHubSignIn" class="w-full text-white bg-primary-500 rounded-md" type="submit">GitHub</button>
                        <button class="w-full text-white bg-primary-400 rounded-md" type="submit">Google</button>
                      </div>
                      ...
                      <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                          Don't have an account? <NuxtLink to="/register" href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Register here</NuxtLink>
                      </p>
                  </form>
              </div>
          </div>
